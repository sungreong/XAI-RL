...
parser.add_argument(
    "--load",
    default=False,
    help="Whether or not to load pretrained weights. " "You must have started an alread trained net for it to work",
    dest="load",
    type=str2bool,
)
parser.add_argument(
    "--render",
    default=True,
    help="Show the game running in a separate process. " "This slows the training a bit",
    dest="render",
    type=str2bool,
)
parser.add_argument(
    "--gif", default=False, help="Create a gif of a game every once in a while", dest="gif", type=str2bool
)
